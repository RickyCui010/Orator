...
from tools.go_straight import GoStraitRun
...
openai_api_key = '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'
...
class OpenaiAgentModule:
    def __init__(self, openai_api_key):
        ...
        self.go_straighttool = GoStraitRun()
        self.tools = [Tool(
                     ...
                     Tool(
                         name=self.go_straighttool.name,
                         func=lambda no_use: self.go_straighttool.run(no_use),
                         description=self.go_straighttool.description
                     )
        ...
        self.llm=ChatOpenAI(temperature=0.3, openai_api_key=self.openai_api_key)
...
if __name__ == '__main__':
    ...
    # print(openaiagentmodule.chat_with_agent('你需要直走一下'))