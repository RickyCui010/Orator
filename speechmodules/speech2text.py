...
class BaiduASR:
    ...
    def _record(self,if_cmu: bool = False, rate=16000):
        with sr.Microphone(sample_rate=rate) as source:
            ...
            audio = self.r.listen(source, timeout=10, phrase_time_limit=2)
    ...
    # 使用百度sdk实现语音识别模块
    def speech_to_text(self, audio_path: str = "speech.wav", if_microphone: bool = True):
        try:
...
if __name__ == '__main__':
    ...
    openai_api_key = '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'
